...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="Date_Visited">Date Visited</label>  
  <div class="col-md-4">
  <input id="Date_Visited" name="Date_Visited" type="date" data-provide="datepicker" placeholder="Date Visited" class="form-control input-md" >
